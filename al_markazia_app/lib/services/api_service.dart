...
class ApiService {
  ...
  static String get baseUrl {
    return const String.fromEnvironment('API_URL', defaultValue: 'http://192.168.3.130:5000/api/v1');
  }

  /// 🔌 Socket Base URL (without /api/v1 prefix — Socket.IO connects to root)
  static String get socketUrl {
    return const String.fromEnvironment('SOCKET_URL', defaultValue: 'http://192.168.3.130:5000');
  }
