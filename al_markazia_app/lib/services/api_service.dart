...
class ApiService {
  ...
  static String get baseUrl {
    return const String.fromEnvironment('API_URL', defaultValue: 'http://10.42.85.143:5000/api/v1');
  }

  /// 🔌 Socket Base URL (without /api/v1 prefix — Socket.IO connects to root)
  static String get socketUrl {
    return const String.fromEnvironment('SOCKET_URL', defaultValue: 'http://10.42.85.143:5000');
  }
