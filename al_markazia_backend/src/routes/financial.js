...
router.post('/close-day', authMiddleware, isAdmin, markAdminBypass, idempotency.guard(true), financialApprovalController.closeDay);
...
router.get('/reports/global', authMiddleware, isAdmin, markAdminBypass, financialReportController.getGlobalDashboard);
router.post('/reports/snapshot/trigger', authMiddleware, isAdmin, markAdminBypass, idempotency.guard(true), financialReportController.triggerSnapshot);
